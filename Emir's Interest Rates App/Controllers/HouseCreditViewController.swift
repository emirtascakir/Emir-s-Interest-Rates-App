//
//  HouseCreditViewController.swift
...
class HouseCreditViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        apiManager.get(url: URL(string: "https://api.collectapi.com/credit/konutKredi")!) { data, error in
            if error != nil {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "houseCell", for: indexPath) as! HouseCustomTableViewCell
